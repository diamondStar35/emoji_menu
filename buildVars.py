...
addon_info = {
	...
	"addon_name": "emojiMenu",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Emoji menu"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""An accessible emoji menu for browsing and copying emojis, With different categories."""),
	# version
	"addon_version": "1.0",
	# Author(s)
	"addon_author": "Abdalrahmen Maher <ramymaherali55@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/diamondStar35/emoji_menu",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/diamondStar35/emoji_menu",
...
pythonSources = ["addon/globalPlugin/emoji_menu/*.py"]
